...
<?php include '../inc/dashHeader.php'; ?>
    <style>
        .wrapper{ width: 1500px; padding-left: 200px; padding-top: 20px  }
        .table td, .table th {
                ...
                if ($result = mysqli_query($link, $sql)) {
                    if (mysqli_num_rows($result) > 0) {
                        ...
                        while ($row = mysqli_fetch_array($result)) {
                            ...
                            echo "<td>";
                            echo '<a href="../menuCrud/deleteMenuVerify.php?id='. $row['item_id'] .'" title="Delete Record" data-toggle="tooltip" class="btn btn-danger btn-sm" '
