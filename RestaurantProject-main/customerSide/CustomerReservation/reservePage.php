...
<body>
    <?php
        // Remove old GET parameter handling for reservation status
        ...
        $message = null;
        if (isset($_SESSION['customer_reservation_message'])) {
            $message = $_SESSION['customer_reservation_message'];
            unset($_SESSION['customer_reservation_message']); // Clear the message after displaying it
        }
    ...
    <div class="reserve-container">
        ...
        <?php if ($message): ?>
            <div id="modernMessage" class="modern-message <?= $message['type'] ?>">
    ...
    <script>
        ...
        if (modernMessage) {
            console.log("Modern message found, setting auto-hide timeout."); // Added for debugging
            setTimeout(() => {
